...
function getMessage(mixed $data): mixed // false | string
{
...
function getData(?int $data): ?string
{
...
$school = new School('nono');
var_dump($school);

echo gettype($school) . "<br>";
echo get_debug_type($school) . "<br>";
