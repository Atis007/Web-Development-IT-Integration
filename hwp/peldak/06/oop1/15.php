...
// It can be extended with placeholder

$submit = new Field("submit", "submit", "send");
$reset = new Field("reset", "reset", "cancel");
// (string $name, string $type, string|int $value = "", string $id = "", int $size = 0, string $label = "")
...
$form1 = new Form("test", "post", "2.php", "first", "form-inline");

echo $form1->renderStart();
echo $email->render();
echo $name->render();
...
echo $submit->render();
echo $reset->render();
echo $form1->renderEnd();

$form2 = new Form("test2", "get", "3.php");
echo $form2->renderStart();
echo $email->render();
echo $name->render();
echo $city->render();
echo $submit->render();
echo $reset->render();
echo $form2->renderEnd();